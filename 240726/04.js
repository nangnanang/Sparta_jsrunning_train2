...
// 출력값 [20, 25]
var numbers1 = numbers.filter(n=>n>15)
...
var arr1 = arr.filter(n=>n.length>4)
console.log(arr1)
 
5.
var arr = ["banana", "kiwi", "mango", "strawberry", "lime", "orange", "plum", "cherry"];
// 요소의 문자열 길이가 홀수인 요소만 반환하여 출력해주세요
var arr1 = arr.filter(n=>(n.length)%2==1)
console.log(arr1)
...
var student1 = student.some(n=>n.name===null)
console.log(student1)
9.
var arr = ["banana", "kiwi", "mango", "strawberry", "lime", "orange", "plum", "cherry"];
// 문자열 길이가 5를 초과하는 요소가 있는지 검사하는 코드를 작성하고 반환값을 출력해주세요.
var arr1 = arr.filter(n=>n.length>5)
console.log(arr1)
10.
...
var arr1 = arr.some(n=>n<0)
console.log(arr1)

12.
var arr = [1, 5, -3, 10, 0, 8];
// 모든 숫자가 음수인지 판별하는 코드를 작성하고 반환값을 출력해주세요
var arr1 = arr.every(n=>n<0)
console.log(arr1)